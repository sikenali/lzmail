...
import {
  Mail, MailOpen, Send, TrendingUp, TrendingDown,
  ChevronRight, getAccountAvatarBg, Contact
} from '@/lib/icons'
...
export default function Dashboard() {
  ...
  const statCards = [
    ...
    { icon: Contact, iconBg: '#fdf2f2', iconColor: '#c43d3d', trendUp: null, label: '联系人', note: '同步自邮箱' },
  ]
  const statValues = [
  ...
  return (
    <AppShell>
      <div className="px-10 py-8" style={{ backgroundColor: 'var(--background)', minHeight: '100%' }}>
        ...
        <div className="flex gap-5 mt-8">
          {/* Recent emails */}
          <div className="flex-[3] p-6 min-w-0" style={cardStyle}>
            <div className="flex items-center justify-between">
            ...
            <div className="mt-5">
              {loading ? (
                ...
                return (
                  <a key={mail.id} href={`/mail?id=${mail.id}`}
