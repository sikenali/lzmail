...
export const ChevronLeft = icon('ri-arrow-left-s-line')
...
export const Forward = icon('ri-corner-up-right-line')
...
export const Tag = icon('ri-price-tag-2-line')
...
export const Globe = icon('ri-globe-line')
